...
class playGame extends Phaser.Scene
{
    ...
    killPlayer (id){
        var explode = this.add.sprite(others.player[id].x,others.player[id].y,'explode').setScale(2);
        this.anims.create({
            key: 'die',
            frames: this.anims.generateFrameNumbers('explode', {start: 0, end: 15}),
            frameRate: 25,
